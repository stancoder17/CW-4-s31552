...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnMaxSalary()
    {
        ...
        decimal? maxSalary = emps
            .Where(e => e.Sal == emps.Max(e2 => e2.Sal))
            .Select(e => e.Sal)
            .First(); 
    ...
    public void ShouldReturnTotalIncomeIncludingCommission()
    {
        ...
        var result = emps
            .Select(e => new {e.EName, Total = e.Sal + e.Comm.GetValueOrDefault(0)})
            .ToList(); 
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps
            ...
            .Join(grades,
                eds => true,
                s => true,
                (eds, s) => new { eds.EName, eds.DName, eds.Sal, s.Grade, s.Losal, s.Hisal })
